...
- (void)viewDidLoad {
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(160, 150, 100, 100)];
    //initWithFrame控制位置和尺寸
    imageView.image = [UIImage imageNamed:@"denglu.png"];
    [self.view addSubview:imageView];
    //把imageView加到视图中
    
    UILabel *userLabel=[[UILabel alloc]initWithFrame:CGRectMake(60, 320, 90, 50)];
    userLabel.text=@"用户名：";
    [self.view addSubview:userLabel];
    
    _username=[[UITextField alloc]init];
    _username.frame=CGRectMake(130, 325, 210, 40);
    ...
    UILabel *passLabel=[[UILabel alloc]initWithFrame:CGRectMake(60, 390, 90, 50)];
    passLabel.text=@"密   码：";
    [self.view addSubview:passLabel];
    
    _password=[[UITextField alloc]init];
    _password.frame=CGRectMake(130, 395, 210, 40);
    ...
    but.frame=CGRectMake(170, 490, 80, 80);
    ...
    _fogetPassword =[[UILabel alloc]initWithFrame:CGRectMake(100, 640, 90, 50)];
    ...
    _registerUser =[[UILabel alloc]initWithFrame:CGRectMake(240, 640, 90, 50)];
